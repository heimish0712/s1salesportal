...
const PORTAL_MASTER_FIELD_SCHEMA = {
  ...
  phone: { label: '대표번호', headers: ['대표전화번호', '대표번호', '전화번호', '대표 전화번호'], type: 'text' },
  directPhone: { label: '직통번호', headers: ['직통번호', '직통번호or휴대폰번호', '직통번호/휴대폰번호', '직통번호 or 휴대폰번호', '휴대폰번호'], type: 'text' },
  email: { label: '이메일', headers: ['담당자 이메일 주소', '담당자 이메일', '이메일주소', '이메일 주소', '이메일'], type: 'email' },
  address: { label: '고객사 주소', headers: ['고객사 상세 주소', '고객사 주소', '도로명주소', '지번주소', '주소', '상세주소'], type: 'text', wide: true },
  addressCheckNeeded: { label: '주소 확인 필요', headers: ['주소확인필요', '주소 확인 필요'], type: 'checkbox' },
...
const PORTAL_DETAIL_FIELDS = {
  basic: [
    ...
    portalFieldDef_('addressCheckNeeded', { editable: true }),
    portalFieldDef_('memo', { editable: true, wide: true })
  ],
  contract: [
    portalFieldDef_('area', { editable: true }),
    portalFieldDef_('areaCheckNeeded', { editable: true }),
...
const PORTAL_CUSTOMER_LIST_FIELD_HEADERS = {
  ...
  areaCheckNeeded: masterFieldHeaders_('areaCheckNeeded'),
  addressCheckNeeded: masterFieldHeaders_('addressCheckNeeded'),
